...
CREATE TABLE `devolucao_itens` (
  ...
  `qnt_item_devolucao` int NOT NULL,
  PRIMARY KEY (`id_devolucao`),
  KEY `id_venda` (`id_venda`),
  KEY `id_item` (`id_item`),
  CONSTRAINT `devolucao_itens_ibfk_item` FOREIGN KEY (`id_item`) REFERENCES `itens_venda` (`id_item`) ON DELETE CASCADE,
  CONSTRAINT `devolucao_itens_ibfk_venda` FOREIGN KEY (`id_venda`) REFERENCES `vendas` (`id_venda`) ON DELETE CASCADE
