...
CREATE TABLE `devolucao_itens` (
  ...
  `qnt_item_devolvidos` int NOT NULL,
  PRIMARY KEY (`id_devolucao`),
  KEY `id_venda` (`id_venda`),
  KEY `id_item` (`id_item`),
  CONSTRAINT `devolucao_itens_ibfk_1` FOREIGN KEY (`id_venda`) REFERENCES `vendas` (`id_venda`),
  CONSTRAINT `devolucao_itens_ibfk_2` FOREIGN KEY (`id_item`) REFERENCES `itens_vendas` (`id_item`)
