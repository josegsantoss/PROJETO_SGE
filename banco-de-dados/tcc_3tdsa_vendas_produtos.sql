...
CREATE TABLE `vendas_produtos` (
  ...
  CONSTRAINT `vendas_produtos_ibfk_1` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`),
  CONSTRAINT `vendas_produtos_ibfk_2` FOREIGN KEY (`id_venda`) REFERENCES `vendas` (`id_venda`)
