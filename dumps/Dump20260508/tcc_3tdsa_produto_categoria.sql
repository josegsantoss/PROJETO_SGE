...
CREATE TABLE `produto_categoria` (
  ...
  CONSTRAINT `produto_categoria_ibfk_1` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`),
  CONSTRAINT `produto_categoria_ibfk_2` FOREIGN KEY (`id_produto`) REFERENCES `produto` (`id_produto`)
